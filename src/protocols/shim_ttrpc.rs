...
impl TaskClient {
    ...
    pub fn state(&self, req: &super::shim::StateRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::StateResponse> {
        ...
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "State", cres);
        Ok(cres)
    }
    ...
    pub fn create(&self, req: &super::shim::CreateTaskRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::CreateTaskResponse> {
        ...
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Create", cres);
        Ok(cres)
    }
    ...
    pub fn start(&self, req: &super::shim::StartRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::StartResponse> {
        ...
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Start", cres);
        Ok(cres)
    }

    pub fn delete(&self, req: &super::shim::DeleteRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::DeleteResponse> {
        let mut cres = super::shim::DeleteResponse::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Delete", cres);
        Ok(cres)
    }

    pub fn pids(&self, req: &super::shim::PidsRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::PidsResponse> {
        let mut cres = super::shim::PidsResponse::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Pids", cres);
        Ok(cres)
    }

    pub fn pause(&self, req: &super::shim::PauseRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Pause", cres);
        Ok(cres)
    }

    pub fn resume(&self, req: &super::shim::ResumeRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Resume", cres);
        Ok(cres)
    }

    pub fn checkpoint(&self, req: &super::shim::CheckpointTaskRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Checkpoint", cres);
        Ok(cres)
    }

    pub fn kill(&self, req: &super::shim::KillRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Kill", cres);
        Ok(cres)
    }

    pub fn exec(&self, req: &super::shim::ExecProcessRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Exec", cres);
        Ok(cres)
    }

    pub fn resize_pty(&self, req: &super::shim::ResizePtyRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "ResizePty", cres);
        Ok(cres)
    }

    pub fn close_io(&self, req: &super::shim::CloseIORequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "CloseIO", cres);
        Ok(cres)
    }

    pub fn update(&self, req: &super::shim::UpdateTaskRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Update", cres);
        Ok(cres)
    }
    ...
    pub fn wait(&self, req: &super::shim::WaitRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::WaitResponse> {
        ...
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Wait", cres);
        Ok(cres)
    }

    pub fn stats(&self, req: &super::shim::StatsRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::StatsResponse> {
        let mut cres = super::shim::StatsResponse::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Stats", cres);
        Ok(cres)
    }

    pub fn connect(&self, req: &super::shim::ConnectRequest, timeout_nano: i64) -> ::ttrpc::Result<super::shim::ConnectResponse> {
        let mut cres = super::shim::ConnectResponse::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Connect", cres);
        Ok(cres)
    }

    pub fn shutdown(&self, req: &super::shim::ShutdownRequest, timeout_nano: i64) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::client_request!(self, req, timeout_nano, "containerd.task.v2.Task", "Shutdown", cres);
        Ok(cres)
    }
}
